...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        inBankActions.getCash(cash);
        System.out.println(gang.getName() + " выгребли из кассы " + gang.getStolenCash() + "$ и спрятали их в чемодан\n");

        inBankActions.pushEmployeeInChest(luckyCashier);
        System.out.println(gang.getName() + " засунули " + luckyCashier.getName() + " в несгораемый сундук\n");
